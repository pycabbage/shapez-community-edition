...
import { MetaRotatorBuilding, enumRotatorVariants } from "./buildings/rotator"
...
export const enumHubGoalRewardsToContentUnlocked = {
  ...
  [enumHubGoalRewards.reward_rotator]: typed([
    [MetaRotatorBuilding, defaultBuildingVariant],
  ]),
  ...
  [enumHubGoalRewards.reward_rotator_ccw]: typed([
    [MetaRotatorBuilding, enumRotatorVariants.ccw],
  ]),
  [enumHubGoalRewards.reward_rotator_180]: typed([
    [MetaRotatorBuilding, enumRotatorVariants.rotate180],
  ]),
  ...
  [enumHubGoalRewards.reward_splitter]: typed([
    [MetaBalancerBuilding, enumBalancerVariants.splitter],
  ]),
  [enumHubGoalRewards.reward_merger]: typed([
    [MetaBalancerBuilding, enumBalancerVariants.merger],
  ]),
