...
import { Vector, enumAngleToDirection, enumDirection } from "../../core/vector"
...
export const arrayBeltVariantToRotation = [
  enumDirection.top,
  enumDirection.left,
  enumDirection.right,
]
...
export class MetaBeltBuilding extends MetaBuilding {
  ...
  updateVariants(entity, rotationVariant) {
    entity.components.Belt.direction =
      arrayBeltVariantToRotation[rotationVariant]
  }
  ...
  computeOptimalDirectionAndRotationVariantAtTile({
    ...
    const { ejectors, acceptors } =
      root.logic.getEjectorsAndAcceptorsAtTile(tile)
