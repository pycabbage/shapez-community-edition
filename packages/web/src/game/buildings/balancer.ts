...
const overlayMatrices = {
  ...
  [enumBalancerVariants.merger]: generateMatrixRotations([
    0, 1, 0, 0, 1, 1, 0, 1, 0,
  ]),
  [enumBalancerVariants.mergerInverse]: generateMatrixRotations([
    0, 1, 0, 1, 1, 0, 0, 1, 0,
  ]),
  [enumBalancerVariants.splitter]: generateMatrixRotations([
    0, 1, 0, 0, 1, 1, 0, 1, 0,
  ]),
  [enumBalancerVariants.splitterInverse]: generateMatrixRotations([
    0, 1, 0, 1, 1, 0, 0, 1, 0,
  ]),
}
...
export class MetaBalancerBuilding extends MetaBuilding {
  ...
  getAvailableVariants(root) {
    ...
    const available = deterministic ? [] : [defaultBuildingVariant]
