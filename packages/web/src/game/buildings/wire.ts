...
export class MetaWireBuilding extends MetaBuilding {
  ...
  updateVariants(entity, rotationVariant, variant) {
    entity.components.Wire.type =
      arrayWireRotationVariantToType[rotationVariant]
  ...
  computeOptimalDirectionAndRotationVariantAtTile({
    ...
    const wireVariant = enumWireVariantToVariant[variant]
    const connections = {
      top: root.logic.computeWireEdgeStatus({
        tile,
        wireVariant,
        edge: enumDirection.top,
      }),
      right: root.logic.computeWireEdgeStatus({
        tile,
        wireVariant,
        edge: enumDirection.right,
      }),
      bottom: root.logic.computeWireEdgeStatus({
        tile,
        wireVariant,
        edge: enumDirection.bottom,
      }),
      left: root.logic.computeWireEdgeStatus({
        tile,
        wireVariant,
