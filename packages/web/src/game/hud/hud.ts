...
export class GameHUD {
  ...
  initialize() {
    this.signals = {
      buildingSelectedForPlacement: /** @type {Signal<[MetaBuilding|null]>} */ (
        new Signal()
      ),
      selectedPlacementBuildingChanged:
        /** @type {Signal<[MetaBuilding|null]>} */ (new Signal()),
      shapePinRequested: /** @type {Signal<[ShapeDefinition]>} */ (
        new Signal()
      ),
      shapeUnpinRequested: /** @type {Signal<[string]>} */ (new Signal()),
      notification: /** @type {Signal<[string, enumNotificationType]>} */ (
        new Signal()
      ),
      buildingsSelectedForCopy: /** @type {Signal<[Array<number>]>} */ (
        new Signal()
      ),
      pasteBlueprintRequested: /** @type {Signal<[]>} */ (new Signal()),
      viewShapeDetailsRequested: /** @type {Signal<[ShapeDefinition]>} */ (
        new Signal()
      ),
    ...
    this.root.keyMapper
      .getBinding(KEYMAPPINGS.ingame.toggleHud)
      .add(this.toggleUi, this)
