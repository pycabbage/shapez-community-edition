...
export class HUDKeybindingOverlay extends BaseHUDPart {
  ...
  get buildingPlacementActive() {
    ...
    return (
      !this.mapOverviewActive && placer && !!placer.currentMetaBuilding.get()
    )
  }
  ...
  get buildingPlacementSupportsBeltPlanner() {
    ...
    return (
      ...
      placer.currentMetaBuilding
        .get()
        .getHasDirectionLockAvailable(placer.currentVariant.get())
    )
  }
  ...
  createElements(parent) {
    ...
    this.keybindings = [
...

      {
        ...
        keys: [KEYCODE_RMB],
        condition: () =>
          this.mapOverviewActive && !this.blueprintPlacementActive,
      },
...

      {
        ...
        condition: () =>
          !this.anyPlacementActive && !this.anythingSelectedOnMap,
      },
...

      {
        ...
        condition: () =>
          !this.blueprintPlacementActive && this.lastBlueprintAvailable,
      },

      {
        ...
        condition: () =>
          this.buildingPlacementSupportsBeltPlanner && !this.beltPlannerActive,
      },
    ...
    if (!this.root.app.settings.getAllSettings().alwaysMultiplace) {
      this.keybindings.push({
        ...
        condition: () =>
          this.anyPlacementActive && !this.buildingPlacementStaysInPlacement,
      })
    }
