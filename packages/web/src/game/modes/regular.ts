...
import { GameMode, enumGameModeIds, enumGameModeTypes } from "../game_mode"
...
import { REGULAR_MODE_LEVELS, finalGameShape } from "./levels"
...
function generateUpgrades() {
  ...
  const upgrades = {
    ...
    painting: [
      ...
      {
        required: [
          { shape: "WpWpWpWp:CwCwCwCw:WpWpWpWp:CwCwCwCw", amount: 50000 },
        ],
      },
      {
        required: [{ shape: preparementShape, amount: 25000 }],
